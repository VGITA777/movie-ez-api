...
class UserEmailAndUsernameAuthenticationServiceTest {
  ...
  void authenticateUserWithEmail_success_invokesSecurityUtils() {
    ...
    try (MockedStatic<SecurityUtils> securityUtilsMock = mockStatic(SecurityUtils.class)) {
      ...
      assertTrue(
          passed instanceof MovieEzEmailPasswordAuthenticationToken,
      ...
      securityUtilsMock.verify(() -> SecurityUtils.setCurrentAuthentication(
          authenticated,
  ...
  void authenticateUserWithEmail_failure_doesNotInvokeSecurityUtils() {
    ...
    try (MockedStatic<SecurityUtils> securityUtilsMock = mockStatic(SecurityUtils.class)) {
      BadCredentialsException ex = assertThrows(
          ...
          () -> service.authenticateUserWithEmail(
              email,
              password,
              request,
              response
  ...
  void authenticateUserWithUsername_success_invokesSecurityUtils() {
    ...
    try (MockedStatic<SecurityUtils> securityUtilsMock = mockStatic(SecurityUtils.class)) {
      ...
      assertInstanceOf(
          MovieEzUsernamePasswordAuthenticationToken.class,
          passed,
