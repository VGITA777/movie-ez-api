...
/**
 * Model representing the response from the TMDB "Get Latest Movie" endpoint.
 * This model extends {@link MovieDetailsModel} and may include additional fields
 * specific to the latest movie response.
 *
