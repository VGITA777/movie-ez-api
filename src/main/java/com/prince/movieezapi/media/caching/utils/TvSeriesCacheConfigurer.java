...
public class TvSeriesCacheConfigurer {
    ...
    private static void configureTvSeriesCreditsCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_CREDITS,
                                         Caffeine.newBuilder()
                                                 .maximumSize(1000)
    ...
    private static void configureTvSeriesDetailsCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_DETAILS,
                                         Caffeine.newBuilder()
                                                 .maximumSize(1000)
                                                 .expireAfterWrite(Duration.ofDays(7))
                                                 .build());
    ...
    private static void configureTvSeriesImagesCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_IMAGES,
                                         Caffeine.newBuilder()
                                                 .maximumSize(1000)
                                                 .expireAfterWrite(Duration.ofDays(7))
                                                 .build());
    ...
    private static void configureTvSeriesKeywordsCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_KEYWORDS,
                                         Caffeine.newBuilder()
                                                 .maximumSize(500)
                                                 .expireAfterWrite(Duration.ofDays(7))
                                                 .build());
    ...
    public static void configureLatestTvSeriesCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_LATEST,
                                         Caffeine.newBuilder()
                                                 .maximumSize(500)
    ...
    private static void configureTvSeriesRecommendationsCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_RECOMMENDATIONS,
                                         Caffeine.newBuilder()
                                                 .maximumSize(1000)
                                                 .expireAfterWrite(Duration.ofDays(7))
                                                 .build());
    ...
    private static void configureTvSeriesSimilarCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_SIMILAR,
                                         Caffeine.newBuilder()
                                                 .maximumSize(1000)
                                                 .expireAfterWrite(Duration.ofDays(7))
                                                 .build());
    ...
    private static void configureTvSeriesVideosCache(CaffeineCacheManager cacheManager) {
        cacheManager.registerCustomCache(TV_SERIES_VIDEOS,
                                         Caffeine.newBuilder()
                                                 .maximumSize(1000)
                                                 .expireAfterWrite(Duration.ofDays(7))
                                                 .build());
