...
public class UserEmailAndUsernameAuthenticationService {
  ...
  public void authenticateUserWithEmail(
    ...
    MovieEzEmailPasswordAuthenticationToken unauthenticated = MovieEzEmailPasswordAuthenticationToken.unauthenticated(email,
                                                                                                                      password
    );
  ...
  public void authenticateUserWithUsername(
    ...
    MovieEzUsernamePasswordAuthenticationToken unauthenticated = MovieEzUsernamePasswordAuthenticationToken.unauthenticated(username,
                                                                                                                            password
    );
    Authentication authenticated = authenticationManager.authenticate(unauthenticated);
    SecurityUtils.setCurrentAuthentication(authenticated, securityContextRepository, request, response);
