...
public record PlaylistContentsInput(@Required(fieldName = "trackIds") @ListRegexMatch(matchAll = true,
                                                                                      patterns = {"^[a-zA-Z0-9]+$"},
                                                                                      message = "trackIds must be alphanumeric strings") List<String> trackIds) {
